...
const PrivacyPolicy = () => {
    return (
        <div className="privacy-policy">
            ...
            <p>г. <span className="!CITY!"><span>Москва</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; «<span
            ...
            <p>расположенный на доменном имени <span className="!ADRESS!"><span>pushkareva.art</span></span>, может
            ...
            <p>3.1. Настоящая Политика конфиденциальности устанавливает обязательства Администрации сайта
                ...
                данных, которые Пользователь предоставляет по запросу Администрации сайта при записи на сайте изостудии.</p>
            ...
            <p>4.1. Персональные данные Пользователя Администрация сайта изостудии может использовать в
                целях:</p>
            <p>4.1.1. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся оказания услуг, обработки запросов и заявок от Пользователя.</p>
            <p>4.1.2. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.</p>
            <p>4.1.3. Предоставления Пользователю с его согласия, обновлений продукции и услуг, специальных предложений, информации о ценах, новостной рассылки и иных сведений от имени изостудии или от имени партнеров изостудии.</p>
            ...
            <p>9.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать в разделе <span
                className="!NAME8!"><span>Контакты</span></span> сайта изостудии. </p>

            <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу www.<span className="!NAME9!"><span>pushkareva.art</span></span>.
            </p>

            <p>&nbsp;</p>

            <p>Обновлено «<span className="!DAY1!"><span>20</span></span>» <span className="!MONTH1!"><span>января </span></span>
