        ...
        return (
            <div className="adults-draw">
                ...
                <div className="adults-draw-description">
                    <p>В <span className="school">Арт-школу Пушкарёвой</span> приходят люди всех возрастов. Здесь каждому помогают раскрыть
                    ...
                    <p>Не бойтесь быть дебютантом. Главное – непрерывно учиться по жизни. <br/>
