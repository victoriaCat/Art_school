    ...
    render() {
        return (
            <div className="kids-draw">
                ...
                <div className="kids-draw-description">
                    <p>Зачастую дети видят картину красивой, но не понимают какие средства художественной
                        выразительности
                        делают её таковой. </p>
                    ...
                    <p>Благодаря индивидуальному подходу и разделению по возрастным категориям в группах, ребёнок
                        комфортно
                        вольётся в процесс обучения. </p>
                    <p>Продолжительность: {DURATION} часа</p>
                    <p><span className="price">Стоимость: {PRICE} руб.</span>, включая все материалы и удобную упаковку.
                    </p>
